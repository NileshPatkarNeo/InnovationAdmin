...
function validateCompanyName() {
    ...
    if (companyName === '') {
        ...
        document.getElementById('companyNameError').innerText = 'Company Name should be max 50 characters';
        return false;
    }
...
document.getElementById('TermForPharmacy').addEventListener('input', function () {
    document.getElementById('termForPharmacyError').innerText = '';
});
