...
namespace InnovationAdmin.Persistence.Migrations
{
    ...
    [Migration("20240618124831_ClaimStatus_ContractTerms_CategoryTypes_PharmacyType")]
    partial class ClaimStatus_ContractTerms_CategoryTypes_PharmacyType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InnovationAdmin.Domain.Entities.APAccountType", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InnovationAdmin.Domain.Entities.CategoryType", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InnovationAdmin.Domain.Entities.ClaimStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InnovationAdmin.Domain.Entities.ContractTerms", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InnovationAdmin.Domain.Entities.PharmacyType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InnovationAdmin.Domain.Entities.Templates", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PdfTemplateFile")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
