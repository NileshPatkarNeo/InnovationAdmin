...
{
    public class UpdateSysPrefFinancialCommandValidator : AbstractValidator<UpdateSysPrefFinancialCommand>
    {
        private readonly IAsyncRepository<SysPrefCompany> _companyRepository;

        public UpdateSysPrefFinancialCommandValidator(IAsyncRepository<SysPrefCompany> companyRepository)
        {
            _companyRepository = companyRepository;

            RuleFor(p => p.FinancialID)
